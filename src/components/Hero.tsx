  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute top-40 right-32 w-24 h-24 bg-accent-500 rounded-lg rotate-45 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-32 left-1/3 w-20 h-20 bg-success-500 rounded-full animate-float" style={{ animationDelay: '4s' }}></div>
        <div className="absolute bottom-20 right-20 w-28 h-28 bg-warning-500 rounded-lg rotate-12 animate-float" style={{ animationDelay: '1s' }}></div>
      </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-sans">
              Backend Engineer & Systems Architect building scalable, high-performance solutions
            </p>
          </div>
